...
namespace SSASDAX
{
    class Utils
    {
        ...
        public DataTable getStatusDataTable()
        {
            ...
            dtSummary.Columns.Add(new DataColumn("Records", typeof(int)));
            ...
            dtSummary.Columns.Add(new DataColumn("SPID", typeof(int)));
            return dtSummary;
        }

        public DataRow getStatusRow(DataTable dt, String NAME, String STATUS, DateTime SRC_SSASQueryStartTime, 
            DateTime SRC_SSASQueryEndTime, System.Double SRC_SSASQueryExecutionTime,int records, String SRC_Exception, String SRC_DAX,int SPID)
        {
